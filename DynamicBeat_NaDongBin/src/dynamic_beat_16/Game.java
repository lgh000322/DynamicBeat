...
public class Game extends Thread {
	...
	private Image blueFlareImage = new ImageIcon(Main.class.getResource("../images/blueFlareImage.png")).getImage();
	...
	public void screenDraw(Graphics2D g) {
		...
		g.drawImage(blueFlareImage, 485, 370, null);
	}
	...
	public void dropNotes(String titleName) {
		...
		if (titleName.equals("Joakim Karud - Mighty Love") && difficulty.equals("Easy")) {
			...
			beats = new Beat[] { new Beat(startTime + gap * 1, "S"), new Beat(startTime + gap * 3, "D"),
					...
					new Beat(startTime + gap * 22, "S"), new Beat(startTime + gap * 24, "K"),
					...
					new Beat(startTime + gap * 118, "Space"), new Beat(startTime + gap * 119, "D"),
					...
					new Beat(startTime + gap * 242, "S"), new Beat(startTime + gap * 246, "D"),
					...
					new Beat(startTime + gap * 250, "J"), new Beat(startTime + gap * 255, "Space"),
					new Beat(startTime + gap * 257, "K"), new Beat(startTime + gap * 259, "L"),
					...
					new Beat(startTime + gap * 287, "F"), new Beat(startTime + gap * 299, "D"),
		...
		if (titleName.equals("Joakim Karud - Wild Flower") && difficulty.equals("Easy")) {
			int startTime = 1000;
			beats = new Beat[] { new Beat(startTime, "Space"), };
		}

		if (titleName.equals("Joakim Karud - Wild Flower") && difficulty.equals("Hard")) {
			int startTime = 1000;
			beats = new Beat[] { new Beat(startTime, "Space"), };
		}

		if (titleName.equals("Bendsound - Energy") && difficulty.equals("Easy")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
			beats = new Beat[] { new Beat(startTime, "Space"), };
		}

		if (titleName.equals("Bendsound - Energy") && difficulty.equals("Hard")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
			beats = new Beat[] { new Beat(startTime, "Space"), };
		}
